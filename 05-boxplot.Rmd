...
<span>  <span class='fu'><a href='https://ggplot2.tidyverse.org/reference/ggtheme.html'>theme_classic</a></span><span class='op'>(</span><span>base_size <span class='op'>=</span> <span class="fnkc-optional" data-toggle="fnkc-help" data-content="размер текста"><span class='fl'>13</span></span><span class='op'>)</span></span></span>
<span></span>
<span></span><span><span class='fu'><a href='https://ggplot2.tidyverse.org/reference/ggsave.html'>ggsave</a></span><span class='op'>(</span><span class='st'>"plot.png"</span>, <span>width <span class='op'>=</span> <span class="fnkc-optional" data-toggle="fnkc-help" data-content="ширина сохраняемого графика"><span class='fl'>4</span></span></span>, <span>height <span class='op'>=</span> <span class="fnkc-optional" data-toggle="fnkc-help" data-content="высота сохраняемого графика"><span class='fl'>5</span></span><span class='op'>)</span></span></span>
